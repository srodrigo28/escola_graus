				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li><a class="dropdown-item" href="index.php?pag=<?php echo $menu1 ?>">Entradas</a></li>
							<li><a class="dropdown-item" href="index.php?pag=<?php echo $menu5 ?>">Saídas</a></li>
							<li><a class="dropdown-item" href="index.php?pag=<?php echo $menu5 ?>">----------------------</a></li>
							<li><a class="dropdown-item" href="index.php?pag=<?php echo $menu3 ?>">Resumo Financeiro</a></li>
							<li><a class="dropdown-item" href="index.php?pag=<?php echo $menu7 ?>">Usuários</a></li>
						</ul>
					</li>
				</ul>
